    ...
    <>
      ...
      >
        <Head>
          ...
          <meta
            property='og:url'
            content={`https://sushijs.com/${router.asPath}`}
          />
          <link rel='canonical' href={`https://sushijs.com/${router.asPath}`} />
          <meta property='og:type' content={meta.type} />
          <meta property='og:site_name' content='Sushi JS' />
        ...
        >
          ...
          <div className='flex flex-row items-center space-x-4'>
            <a
              href='https://github.com/sushi-js/'
              className='visible'
              target='_blank'
              rel='noreferrer'
              aria-label='Github'
        ...
        <motion.nav
          animate={{ y: 50 }}
          transition={{ duration: 0.5 }}
          className='sticky w-full bg-green-200 z-[1] filter-blur dark:bg-sky-900/40 top-2 md:top-4 max-w-2xl px-4 py-2 rounded-md mx-auto flex justify-between items-center'
        >
          <div className='flex flex-row gap-1 text-tertiary'>
            <Link href='/'>
              <a className='hover:text-primary transition-all cursor-pointer'>
