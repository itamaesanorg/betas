      ...
      <div className="bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-xl font-semibold text-black dark:text-white tracking-wide uppercase">1988</h2>
            <p className="text-xl font-semibold text-black dark:text-white tracking-wide uppercase">
              Maribel Risquez
            </p>
