...
Muchas gracias por su colaboración.
    ...
    ¿Quiénes somos?
    Nuestra denominación: BARCELONA HOSTESS S.L.
    Nuestro CIF / NIF: B61614145
    Nuestra actividad principal: Azafatas, promotores de ventas y personal auxiliar
    Nuestra dirección: C/ Fontanella 10, entlo. 3ª, CP 08010, BARCELONA (Barcelona)
    Nuestro teléfono de contacto: 933426265
    Nuestra dirección de correo electrónico de contacto: comercial@bcnhostess.com
    Nuestra página web: bcnhostess.com
